...
Sei $f \in F$ der zu prüfende Fahrstuhl, $c$ die neue Anfrage und $check\_on\_way$ eine Funktion die prüft ob ein Stockwerk in Fahrtrichtung eines Fahrstuhls liegt, dann sind die in Frage kommenden Fahrstühle $F_{f}$:
\begin{align}
