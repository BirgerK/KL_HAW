...
final class References {
	...
	/**
	 * Determines all entries in the finger table.
	 * 
	 * @return The all entries of finger table.
	 * 
	 */
	public List<Node> getFingerTableEntries() {
		return this.fingerTable.getFingerTableEntries();
	}
	
	/**
	 * 
	 * @return An array copy of the finger table
	 */
	public Node[] getFingerTableCopy () {
		return this.fingerTable.getCopyOfReferences();
	}
