...
public final class NodeImpl extends Node {
	 ...
	 * other nodes. Sole constructor, is invoked by ExtendedChordImpl only.
	 * 
	 * @param impl
	 *            Reference on ExtendedChordImpl instance which created this object.
	 * @param nodeID
